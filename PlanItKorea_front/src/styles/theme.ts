...
primary: {
    main: '#82AEF5', // 메인 색상: 버튼, 아이콘 등 주요 요소에 사용
    light: '#BECDF8', // 푸터 색상
    dark: '#5F7DFF',  // 메인 색상의 호버 색상
...
secondary: {
    main: '#E50914', // 결제 취소
    light: '#DD1162', // 찜 버튼
    dark: '#CA3232',  // 결제 취소 호버
    contrastText: '#ffffff' // 대비되는 텍스트 색상
},
...
text: {
    ...
    secondary: '#2B6678', // 보조 텍스트 색상
    disabled: '#c4c4c4'   // 비활성화된 텍스트 색상
}
},
typography: {
